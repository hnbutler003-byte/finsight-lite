...
- A getting-started checklist with four steps: create a class, add students, post a challenge or quiz, and explore the lesson library. The checklist disappears automatically once all four items are complete.
...
- **Getting started checklist**: four onboarding steps similar to the teacher checklist.
