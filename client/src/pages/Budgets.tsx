                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormControl>
                                    <Input type="number" {...field} className="bg-white/50 backdrop-blur-sm border-white/50 rounded-xl text-gray-800 placeholder:text-gray-400 focus:ring-2 focus:ring-violet-400" />
                                  </FormControl>
                                </FormItem>
                              )}
                            />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {budgets?.length === 0 && (
                  <div className="col-span-full text-center py-12 bg-card rounded-xl border border-dashed border-border">
                    <p className="text-muted-foreground">No budgets set up yet. Create one to start saving!</p>
                  </div>
                )}
              </div>
