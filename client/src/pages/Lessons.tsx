...
function SectionVideoBlock({ section, index }: { section: ContentSection; index: number }) {
...
function SectionDiagram({ diagram, index }: { diagram: ContentDiagram; index: number }) {
...
function LessonContentBlock({ section, index }: { section: ContentSection; index: number }) {
